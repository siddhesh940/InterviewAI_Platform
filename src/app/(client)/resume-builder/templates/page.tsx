              ...
              <CardHeader>
                ...
                <div className="h-48 bg-white border-2 border-gray-200 rounded-lg mb-4 overflow-hidden relative">
                  <div className={`h-12 ${template.color} flex items-center px-4`}>
                    <div className={`h-2 w-24 bg-white bg-opacity-80 rounded`}></div>
                  </div>
                  <div className="p-4 space-y-2">
                    <div className="h-1 w-16 bg-gray-300 rounded"></div>
                    <div className="h-1 w-20 bg-gray-200 rounded"></div>
                    <div className="h-1 w-24 bg-gray-300 rounded mt-3"></div>
                    <div className="h-1 w-32 bg-gray-200 rounded"></div>
                    <div className="h-1 w-28 bg-gray-200 rounded"></div>
